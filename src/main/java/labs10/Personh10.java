...
public class Personh10 extends Human {
    ...
    public Personh10(String name, int age) {

       this(name,age, Genderh8.UNKNOWN);
    }

    public Personh10(String name, int age, Genderh8 gender){
        this(name, age, gender, "01-01-1970");
    }

    public Personh10(String name, int age, Genderh8 gender, String dateOfBirth) {
        this.age = age;
        this.name = name;
        this.gender = gender;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Personh10)) return false;
        Personh10 personh8 = (Personh10) o;
